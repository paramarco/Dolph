...
securities = []
securities = [
    {   # Calibrated 2026-02-17 | profit score: 2568.74 -> 3190.71 (30d/15K rows)
        'seccode': 'AAPL',
        'board': 'EQTY',
        'market': 'NASDAQ',
        'decimals': 2,
        ...
        'params': {
            ...
            'positionMargin': 0.001715,
            'stopLossCoefficient': 13,
            'period': '1Min',
            # VCP
            ...
            'EXPANSION_RSI_LONG_MAX': 49,
            # Trend Phase Thresholds
            'TREND_RSI_LONG_MIN': 20,
            'TREND_RSI_LONG_MAX': 87,
            'TREND_RSI_SHORT_MIN': 15,
            'TREND_RSI_SHORT_MAX': 55,
            # Margin Adaptation Parameters
            'MARGIN_CONTRACTION_FIXED': 0.001095,
            'MARGIN_EXPANSION_MULTIPLIER': 1.365,
            'MARGIN_EXPANSION_MIN': 0.002711,
            'MARGIN_EXPANSION_MAX': 0.00728,
            'MARGIN_TREND_ATR_MULTIPLIER': 2.934286,
            'MARGIN_TREND_MIN': 0.002741,
            'MARGIN_TREND_MAX': 0.00510,
    ...
    {   # Calibrated 2026-02-17 | profit score: 880.35 -> 1256.37 (30d/15K rows)
        'seccode': 'INTC',
        'board': 'EQTY',
        'market': 'NASDAQ',
        'decimals': 3,
        ...
        'params': {
            ...
            'period': '1Min',
            # VCP
            'VCP_ATR_SLOPE_EXPANSION': 0.205562,
            'VCP_BB_WIDTH_PERCENTILE_EXPANSION': 0.245,
            'VCP_ADX_TREND_THRESHOLD': 13,
            # Indicator Periods
            'EMA_FAST': 10,
            ...
            # Margin Adaptation Parameters
            'MARGIN_CONTRACTION_FIXED': 0.001005,
            'MARGIN_EXPANSION_MULTIPLIER': 1.095,
            'MARGIN_EXPANSION_MIN': 0.00182,
            'MARGIN_EXPANSION_MAX': 0.00536,
            'MARGIN_TREND_ATR_MULTIPLIER': 3.38,
            'MARGIN_TREND_MIN': 0.00338,
            ...
            'VOLUME_SLOPE_WINDOW': 4,
            'BIG_VOLUME_THRESHOLD': 1.638,
            'EXTREME_VOLUME_THRESHOLD': 2.554,
            'BIG_BODY_ATR_THRESHOLD': 0.588,
            'EXTREME_BODY_ATR_THRESHOLD': 2.266,
            'DIVERGENCE_LOOKBACK': 10,
            # Buying Climax
            'BUYING_CLIMAX_LOOKBACK': 10,
            'BUYING_CLIMAX_TREND_LOOKBACK': 15,
            'BUYING_CLIMAX_EXTENSION': 0.004650,
            'BUYING_CLIMAX_COOLDOWN_SECONDS': 900,
            # Final Decision Scoring
            'MIN_TOTAL_SCORE': 0.735,
            'MIN_CONFIDENCE': 0.294,
    ...
    {   # Calibrated 2026-02-17 | profit score: 2169.90 -> 2845.23 (30d/15K rows)
        'seccode': 'NVDA',
        'board': 'EQTY',
        'market': 'NASDAQ',
        'decimals': 2,
        ...
        'params': {
            ...
            'minNumPastSamples': 51,
            'positionMargin': 0.001715,
            'stopLossCoefficient': 12,
            'period': '1Min',
            # VCP
            'VCP_ATR_SLOPE_EXPANSION': 0.2535,
            'VCP_BB_WIDTH_PERCENTILE_EXPANSION': 0.335,
            'VCP_ADX_TREND_THRESHOLD': 14,
            # Indicator Periods
            'EMA_FAST': 14,
            'EMA_MID': 16,
            'EMA_SLOW': 24,
            ...
            'BB_WINDOW': 12,
            'BB_STD': 2,
            'BB_PERCENTILE_WINDOW': 67,
            'FVP_WINDOW': 20,
            # Expansion Phase Thresholds
            'EXPANSION_DEVIATION_THRESHOLD': 0.000245,
            'EXPANSION_RSI_SHORT_MIN': 20,
            'EXPANSION_RSI_LONG_MAX': 33,
            # Trend Phase Thresholds
            'TREND_RSI_LONG_MIN': 20,
            ...
            'MARGIN_EXPANSION_MAX': 0.004880,
            'MARGIN_TREND_ATR_MULTIPLIER': 3.38,
            'MARGIN_TREND_MIN': 0.002488,
            'MARGIN_TREND_MAX': 0.008847,
            # Calibration Parameters
            'CALIBRATION_LOOKBACK_DAYS': 30,
            'CALIBRATION_LIMIT_RESULTS': 15000,
            'CALIBRATION_MIN_ROWS': 1000,
            ...
            'EXTREME_VOLUME_THRESHOLD': 2.275,
            'BIG_BODY_ATR_THRESHOLD': 0.588,
            'EXTREME_BODY_ATR_THRESHOLD': 1.967,
            'DIVERGENCE_LOOKBACK': 7,
            # Buying Climax
            'BUYING_CLIMAX_LOOKBACK': 10,
            'BUYING_CLIMAX_TREND_LOOKBACK': 22,
            'BUYING_CLIMAX_EXTENSION': 0.005869,
            'BUYING_CLIMAX_COOLDOWN_SECONDS': 900,
            # Final Decision Scoring
            'MIN_TOTAL_SCORE': 0.735,
            'MIN_CONFIDENCE': 0.294,
